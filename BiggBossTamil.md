# Bigg Boss Tamil 7 App's Privacy policy
...
Bigg Boss Tamil requires only internet permission to fetch the bigg boss show details. Otherwise, no special permission is required
...
Bigg Boss Tamil does not contain links to any other service provider. The software works independently on its own. However, it may fetch few image details that are subject to respective own copy rights
